...
const fetchAndRenderHistoryChart = async () => {
  ...
  const formData = {
    ...
    fromDate: historyDateRange.value[0],
    toDate: historyDateRange.value[1],
  };
      ...
      <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex mt-6">
          ...
          <div class="w-1/3 pl-4">
            <CardBox v-if="selectedComparison" class="h-full">
              <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold">{{ selectedComparison.machine_name }} History</h2>
                <Button @click="selectedComparison = null" icon="close">
